        ...
        <div className="hero-content-wrapper">
          <div className="hero-text-column">
            ...
            <p className="hero-bio">
              I craft exceptional digital experiences that combine stunning
              design with flawless functionality. My work focuses on creating
              intuitive, responsive solutions that help businesses achieve their
              goals.
            </p>
